			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>
						...
						<a href="../file/coursestu_list.jsp">首页</a>
			...
			<div class="row">
				<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption"><i class="fa fa-cogs"></i>课程信息查看</div>
					</div>
					<div class="portlet-body">
						...
						<div class="clearfix" style="margin-top:10px">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label class="control-label col-md-3">选课总学分</label>
									<div class="col-md-9">
						...
						<div class="clearfix">
							<table class="table table-bordered table-striped">
								<thead>
									<tr>
										<td>课程号</td><td>课程名称</td><td>授课教师</td><td>课程属性</td><td>上课地点</td><td>学分</td>
									</tr>
								</thead>
