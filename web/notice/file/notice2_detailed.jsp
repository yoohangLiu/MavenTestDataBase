...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			修改公告 <small>公告增添、删除、修改、查询、统计、导出、打印</small>
			</h3>
			<!-- 结束：这里是页面当前位置的指示  -->
			...
			<div class="row">
				<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption"><i class="fa fa-cogs"></i>修改公告</div>
					</div>
							...
							<form action="#" class="form-horizontal form-bordered">
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" id="course_id" class="form-control" placeholder="请输入班级号">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3"><span style="color:red">*</span>发布时间</label>
										<div class="col-md-3">
											<input type="text" id="create_time" class="form-control" placeholder="请输入发布时间" readonly></div>
											<script>
												jeDate({
...
<script src="../file_js/notice2_detailed.js"></script>